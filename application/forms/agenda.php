	...
	<div class="form-group" >
		...
		<div class="input-group" id="grp_txt_idempleado<?php echo $NumWindow; ?>">	
			...
			<span class="input-group-btn">	
				<button class="btn btn-success" type="button" data-toggle="modal" data-target="#GnmX_Search" data-whatever="Medico" onclick="javascript:CargarSearch('ProfesionalesSalud', 'txt_idempleado<?php echo $NumWindow; ?>', 'NULL');"><i class="fas fa-search"></i></button>
			</span>
		</div>
	</div>
