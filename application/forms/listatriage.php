...
<br>
<a class="btn btn-success btn-xs btn-block" href="javascript:RefreshListaTriage<?php echo $NumWindow; ?>()" role="button" title="Actualizar Listados de Pacientes"> Actualizar <span class="glyphicon glyphicon-retweet" aria-hidden="true"></span> </a>
<br>
	<label class="label label-default"> Volver a Llamar</label>
	<div class="table-responsive">
		<table class="table table-condensed table-striped table-hover tblDetalle">
		    <tbody id="tbDetalleY<?php echo $NumWindow; ?>">
				<tr id="trh<?php echo $NumWindow; ?>"> 
				    <th id="th1<?php echo $NumWindow; ?>">Consecutivo</th> 
				    <th id="th3<?php echo $NumWindow; ?>">Documento</th> 
					<th id="th4<?php echo $NumWindow; ?>">Nombre Paciente</th> 
					...
					<th id="th5<?php echo $NumWindow; ?>">Tiempo</th>
					<th id="th6<?php echo $NumWindow; ?>">Clasificación</th>
					<th id="th6<?php echo $NumWindow; ?>">Realizar Llamado</th>
				</tr> 
					<?php 
