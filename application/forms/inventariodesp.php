...
<script src="functions/nexus/inventariodesp.js?v=<?php echo $_SESSION["VERSION_CONTROL"]; ?>.<?php echo $NumWindow; ?>"></script>
<script >
...
function DespMedSol<?php echo $NumWindow; ?>() {
	DespMedSol2('<?php echo $NumWindow; ?>',document.getElementById('cmb_filtroarea<?php echo $NumWindow; ?>').value, document.getElementById('txt_filtropcte<?php echo $NumWindow; ?>').value, document.getElementById('txt_fitrofecini<?php echo $NumWindow; ?>').value, document.getElementById('txt_fitrofecfin<?php echo $NumWindow; ?>').value );
}
