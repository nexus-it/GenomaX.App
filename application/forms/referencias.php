...
<div class="form-group">
	...
	<div class="input-group">	
		...
		<span class="input-group-btn">	
			<button class="btn btn-success" type="button" data-toggle="modal" data-target="#GnmX_Search" data-whatever="ServiciosX" onclick="javascript:CargarSearch('ServiciosX2', 'txt_codigo<?php echo $NumWindow; ?>', 'Tipo_SER=*2*');"><i class="fas fa-search"></i></button>
		</span>
	</div>
</div>
