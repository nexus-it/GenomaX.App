		...
		<div class="input-group">
			<input name="txt_cotizacion<?php echo $NumWindow; ?>" id="txt_cotizacion<?php echo $NumWindow; ?>" type="text" onkeypress="BuscarCTZ<?php echo $NumWindow; ?>(event);" value="<?php echo $noctz; ?>"/>
			 <span class="input-group-btn"> 		
	 		  <button class="btn btn-success" type="button" data-toggle="modal" data-target="#GnmX_Search" data-whatever="Cotizacion" onclick="javascript:CargarSearch('KlCotizacion', 'txt_cotizacion<?php echo $NumWindow; ?>', 'Estado_CTZ=*1*');"><span class="glyphicon glyphicon-search" aria-hidden="true"></span></button>
			 </span>
		</div>
	</div>
