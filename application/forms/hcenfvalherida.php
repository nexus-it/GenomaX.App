		...
		<div class="col-md-3 ">
	  	...
	  	<div id="divformatohc<?php echo $NumWindow; ?>" class="col-md-12">
			...
			echo '
				...
				<div class="form-group">
				  	<label for="cmb_curaciones'.$NumWindow.'">Curación</label>
				  	<select name="cmb_curaciones'.$NumWindow.'" id="cmb_curaciones'.$NumWindow.'">
				  		<option value="0">- NO -</option>
			';
			$SQL="Select Codigo_HTC, Nombre_HTC from hctipocuraciones order by Codigo_HTC";
			$resultz = mysqli_query($conexion, $SQL);
			while($rowz = mysqli_fetch_array($resultz)) 
				{
				echo '
			...
			<div class="col-md-2">
				...
				<div class="form-group">
				  	<label for="txt_dispositivo'.$NumWindow.'">Cambio Disp.</label>
					<div class="input-group">	
			...
			<div class="col-md-7">
				...
				<div class="form-group">
				  	<label for="txt_nombreserv'.$NumWindow.'">Nombre Dispositivo</label>
					<input name="txt_nombreserv'.$NumWindow.'" id="txt_nombreserv'.$NumWindow.'" type="text" disabled="disabled" />
				</div>
	  		...
	  		<div class="col-md-12">
	  			<div class="row well">
		  			<div class="col-md-12 btn-group">
			  			<button class="btn btn-warning" type="button" data-toggle="collapse" data-target="#xApMed<?php echo $NumWindow; ?>" aria-expanded="false" aria-controls="xApMed<?php echo $NumWindow; ?>">
						  <span class="glyphicon glyphicon-briefcase" aria-hidden="true"></span> Aplicación de Medicamentos
						</button>
						<?php 
						/*
						?>
						<button class="btn btn-primary" type="button" data-toggle="collapse" data-target="#xCtrLiq<?php echo $NumWindow; ?>" aria-expanded="false" aria-controls="xCtrLiq<?php echo $NumWindow; ?>">
						  <span class="glyphicon glyphicon-tint" aria-hidden="true"></span> Control de Líquidos
						</button>
						<button class="btn btn-primary" type="button" data-toggle="collapse" data-target="#xCtrGluc<?php echo $NumWindow; ?>" aria-expanded="false" aria-controls="xCtrGluc<?php echo $NumWindow; ?>">
						  <span class="glyphicon glyphicon-map-marker" aria-hidden="true"></span> Control de Glucometrías
						</button>
						<?php 
						*/
						?>
					</div>
					<div class="col-md-12 collapse" id="xApMed<?php echo $NumWindow; ?>">
						<label class="label label-default pull-right"> APLICACIÓN DE MEDICAMENTOS</label>
					  <div class="well row">
					    <div class="col-md-10">
			...
			?>
				 ...
				 <p class="text-success"><em><small><strong>*</strong>  No administre un medicamento que usted o el sistema de preparación no hayan preparado.</small></em></p>
					...
					<div class="col-md-12 collapse" id="xCtrLiq<?php echo $NumWindow; ?>">
						<label class="label label-default"> Control de Líquidos</label>
					  <div class="well row">
					    ...
					  </div>
					</div>

					<div class="col-md-12 collapse" id="xCtrGluc<?php echo $NumWindow; ?>">
						<label class="label label-default"> Control de Glucometrías</label>
					  <div class="well row">
					    ...
					  </div>
					</div>
