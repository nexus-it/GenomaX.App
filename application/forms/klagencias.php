...
<label class="label label-default"><span class="glyphicon glyphicon-user" aria-hidden="true"></span> Promotores</label>
	<div class="row well well-sm">
	  		...
	  		<div class="col-md-1">
					<button class="btn btn-success" type="button"  onclick="javascript:Addusuario<?php echo $NumWindow; ?>();"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span></button>
	  		</div>
			<div class="col-md-12">
