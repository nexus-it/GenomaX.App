...
if(!empty($_POST['companyName']) && $_POST['companyName']) {	
	$invoice->saveNc($_POST);
	//header("Location:nclist");	
}
...
/*
    ...
    $datosEmp = validarRegistroEmpRes($verficarEmpresaReg["NIT_DCD"]);
		...
		echo "<script>alert('No podras generar NC sin antes haber registrado tu empresa, seras redireccionado a el modulo de registro para completar los datos...');
...
<form action="application/forms/facturadeventaNC.php" id="invoice-form" method="post" class="invoice-form" role="form" > <!--novalidate-->
<div class="load-animate animated fadeInUp">
<div class="row">
<div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
    <h2 class="title">Sistema de Facturacion - Crear Nota Credito</h2>
</div>		    		
</div>
...
<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 pull-right">
	<div class="form-group">
        ...
        <input required="true" type="text" class="form-control" name="facturasId" id="facturasId" placeholder="Factura acreditar" autocomplete="off" required   >
    </div>
    <h3>Para,</h3>
    <div class="form-group">
...
<div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
    ...
    <div class="form-group">
        ...
        <input data-loading-text="Guardando NC..." type="submit" name="invoice_btn" value="Guardar NC" class="btn btn-success submit_btn invoice-save-btm">						
    </div>
