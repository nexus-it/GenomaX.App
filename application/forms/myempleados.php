...
<fieldset>
  ...
  <p align="center"><img src="http://cdn.genomax.co/media/image/fomplusnet_logo.jpg" width="200" height="34" align="baseline" /> ==&gt;&gt;<img src="http://cdn.genomax.co/media/image/aquamark.png" width="100" height="100" align="absmiddle" /></p>
...
function ProgresSync<?php echo $NumWindow; ?>(Orden, Contender, Datos) {
	...
	if (Orden=='7') {
		setTimeout(InsertarHTML('Sync_'+Orden+'_<?php echo $NumWindow; ?>', '[Cargos Homologados]<div align="center"><img src="http://cdn.genomax.co/media/image/button_ok.png" border="0" align="absmiddle" /></div>'), 7000);
	}
}
