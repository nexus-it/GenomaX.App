...
<div class="form-group">
  ...
  <input name="txt_cantidad<?php echo $NumWindow; ?>" type="text" id="txt_cantidad<?php echo $NumWindow; ?>" onkeypress="AgregarFila<?php echo $NumWindow; ?>(event);"/>
    <span class="input-group-btn">
   <button class="btn btn-success" type="button" onclick="javascript:AgregarFilaOrden(document.frm_form<?php echo $NumWindow; ?>.txt_codigo<?php echo $NumWindow; ?>.value, document.frm_form<?php echo $NumWindow; ?>.hdn_codigox<?php echo $NumWindow; ?>.value, document.frm_form<?php echo $NumWindow; ?>.txt_nombreserv<?php echo $NumWindow; ?>.value,document.frm_form<?php echo $NumWindow; ?>.txt_cantidad<?php echo $NumWindow; ?>.value,document.getElementById('cmb_medico<?php echo $NumWindow; ?>').options[document.getElementById('cmb_medico<?php echo $NumWindow; ?>').selectedIndex ].text,document.frm_form<?php echo $NumWindow; ?>.cmb_medico<?php echo $NumWindow; ?>.value, '<?php echo $NumWindow; ?>', document.frm_form<?php echo $NumWindow; ?>.hdn_controw<?php echo $NumWindow; ?>.value, '<?php echo $_SESSION["THEME_DEFAULT"]; ?>');"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Agregar</button>
 </span>
 </div>
</div>
