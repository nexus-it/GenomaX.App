...
$Orientation="P";
$NombreEmpresa="";
$SQL="SELECT sql_rpt, page_rpt, orientacion_rpt, RazonSocial_DCD from ".$_SESSION['DB_NXS'].".itreports, itconfig where codigo_rpt='carterafacvsrad'";
...
$pdf->Settitle('FACTURADO Vs RADICADO Vs RECAUDADO');
...
$pdf->Cell(75,6,'CLIENTE','LT',0,'C',0);
$pdf->Cell(90,6,'FACTURADO','BR',0,'C',0);
$pdf->Cell(30,6,'RADICADO','BR',0,'C',0);
$pdf->Cell(30,6,'RECAUDADO','BR',0,'C',0);
$pdf->SetY(40);
$pdf->Ln();
$pdf->Cell(60,6,'ENTIDAD','BR',0,'C',0);
$pdf->Cell(15,6,'TIPO','BR',0,'C',0);
$pdf->Cell(30,6,'FACTURADO','BR',0,'C',0);
$pdf->Cell(30,6,'RADICADO','BR',0,'C',0);
$pdf->Cell(30,6,'RECAUDADO','BR',0,'C',0);
$pdf->SetY(40);
$pdf->Ln();
...
while($row = mysqli_fetch_row($result)) {
    $SQL="Select month(a.Fecha_FAC), sum(a.ValTotal_FAC) From gxfacturas a Where a.Estado_FAC<>'0' and month(a.Fecha_FAC)='".$row[2]."' and year(a.Fecha_FAC)='".$row[1]."' Group By month(a.Fecha_FAC)";
