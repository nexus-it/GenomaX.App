...
$Orientation="P";
$SQL="SELECT sql_rpt, page_rpt, orientacion_rpt from ".$_SESSION['DB_NXS'].".itreports where codigo_rpt='devoluciones'";
...
$pdf->Settitle('DEVOLUCIONES DE MEDICAMENTOS');
...
// echo $SQL;
        ...
        $pdf->Cell(0,6,'DEVOLUCIONES DE MEDICAMENTOS','',0,'C',0); //Razon Social
        $pdf->Ln();
