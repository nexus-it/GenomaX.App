...
$this->Cell(0,10,'ATENCIONES POR PROFESIONAL ENTRE EL '.$_GET["FECHA_INICIAL"].' Y EL '.$_GET["FECHA_FINAL"],'B',0,'C',0);
$this->SetY(10);
$this->SetFont('Arial','',9);
...
$Orientation="P";
$NombreEmpresa="";
$SQL="SELECT sql_rpt, page_rpt, orientacion_rpt, RazonSocial_DCD from ".$_SESSION['DB_NXS'].".itreports, itconfig where codigo_rpt='activxprofesional'";
//echo $SQL;
...
$pdf->SetFillColor(255);
$pdf->SetFont('Arial','',9);
$pdf->Cell(140,5,$row[1],'BLR',0,'L',0); //INGRESO
$pdf->Cell(25,5,$row[2],'BLR',0,'C',0); //FECHA
$pdf->Cell(0,5,'','BLR',0,'C',0); //FECHA
$pdf->Ln();
$KontaPcte++;
}
...
$pdf->Cell(165,5,'Total Pacientes','LBR',0,'R',0); //FECHA
$pdf->Cell(0,5,$KontaPcte,'BLR',0,'C',0); //FECHA
$pdf->Ln();
//mysqli_close();
