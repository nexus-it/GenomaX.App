...
$SQL="SELECT sql_rpt from ".$_SESSION['DB_NXS'].".itreports where codigo_rpt='hcformulamedica'";
...
if ($rowH = mysqli_fetch_row($resultH)) {
	...
	$this->Cell(0,6,'FORMULA MEDICA','',0,'C',0);
	$this->Ln();
...
$Orientation="P";
$NombreEmpresa="";
$SQL="SELECT page_rpt, orientacion_rpt from ".$_SESSION['DB_NXS'].".itreports where codigo_rpt='hcformulamedica'";
