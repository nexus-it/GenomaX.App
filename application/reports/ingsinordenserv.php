...
$this->Cell(22,6,'INGRESO','BR',0,'C',0);
$this->Cell(25,6,'FECHA','BR',0,'C',0);
$this->Cell(22,6,'DOCUMENTO','BR',0,'C',0);
$this->Cell(46,6,'NOMBRE PACIENTE','BR',0,'C',0);
...
$Orientation="P";
$NombreEmpresa="";
$SQL="SELECT sql_rpt, page_rpt, orientacion_rpt, RazonSocial_DCD from ".$_SESSION['DB_NXS'].".itreports, itconfig where codigo_rpt='ingsinordenserv'";
...
$pdf->Settitle('LISTADO INGRESOS SIN SERVICIOS POR PERIODO');
...
$pdf->Cell(22,5,$row[0],'',0,'C',0); //INGRESO
$pdf->Cell(25,5,$row[1],'',0,'C',0); //FECHA
$pdf->Cell(22,5,$row[2],'',0,'R',0); //DOCUMENTO
$pdf->Cell(46,5,ucwords(strtolower($row[3])),'',0,'L',1); //ENTIDAD
$pdf->Cell(26,5,$row[4],'',0,'L',1); //TIPO
$pdf->Cell(0,5,ucwords(strtolower($row[5])),'',0,'L',1); //ENTIDAD
$pdf->Ln();
$totalfacts++;
}
mysqli_free_result($result);
...
$pdf->Cell(170,6,"Notas ingresos sin cargos elaboradas en el periodo: ".$totalfacts,'T',0,'L',1); //ESTADO
