...
$SQL="SELECT sql_rpt from nxs_gnx.itreports where codigo_rpt='hcayudasdx'";
...
$Orientation="P";
$NombreEmpresa="";
$SQL="SELECT page_rpt, orientacion_rpt from nxs_gnx.itreports where codigo_rpt='hcayudasdx'";
