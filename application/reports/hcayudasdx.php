...
$SQL="SELECT sql_rpt from ".$_SESSION['DB_NXS'].".itreports where codigo_rpt='hcayudasdx'";
...
$Orientation="P";
$NombreEmpresa="";
$SQL="SELECT page_rpt, orientacion_rpt from ".$_SESSION['DB_NXS'].".itreports where codigo_rpt='hcayudasdx'";
...
$SQL="Select distinct left(d.CUPS_PRC,1) From gxservicios a, hcordenesdx b, czterceros c, gxprocedimientos d Where a.Codigo_SER=b.Codigo_SER and b.Codigo_TER=c.Codigo_TER and d.Codigo_SER=b.Codigo_SER and c.ID_TER='".$_GET["HISTORIA"]."' and b.Codigo_HCF='".$_GET["FOLIO_INICIAL"]."' order by 1";
$resultdX = mysqli_query($conexion, $SQL);
$TipoDx="";
while ($rowdX = mysqli_fetch_row($resultdX)) {
$pdf->AddPage();
...
while ($rowx = mysqli_fetch_row($resultx)) {
	...
	// ORDENES DE DX
		$SQL="Select left(d.CUPS_PRC,1), d.CUPS_PRC, d.Nombre_PRC, b.Cantidad_HCS, b.Observaciones_HCS From gxservicios a, hcordenesdx b, czterceros c, gxprocedimientos d Where a.Codigo_SER=b.Codigo_SER and b.Codigo_TER=c.Codigo_TER and d.Codigo_SER=b.Codigo_SER and c.ID_TER='".$_GET["HISTORIA"]."' and b.Codigo_HCF='".$rowx[1]."' and left(d.CUPS_PRC,1)='".$rowdX[0]."' order by 2";
		$resultx2 = mysqli_query($conexion, $SQL);
		/*$pdf->SetFont('Arial','B',8);
		$pdf->SetFillColor(180);
		...
		while ($rowx2 = mysqli_fetch_row($resultx2)) {
			...
			$pdf->SetFont('Arial','B',8);
			$pdf->MultiCell(0,4,utf8_decode($rowx2[2]),'TLR','L',1);
			$pdf->SetFillColor(255);
