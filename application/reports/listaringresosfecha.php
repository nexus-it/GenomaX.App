...
$this->Cell(0,10,'LISTADO DE ADMISIONES ENTRE EL '.$_GET["FECHA_INICIAL"].' Y EL '.$_GET["FECHA_FINAL"],'B',0,'C',0);
$this->SetY(10);
$this->SetFont('Arial','',9);
...
$this->Cell(32,7,'FECHA','BR',0,'C',0);
$this->Cell(32,7,'DOCUMENTO','BR',0,'C',0);
$this->Cell(55,7,'PACIENTE','BR',0,'C',0);
$this->Cell(25,7,'TIPO','BR',0,'C',0);
$this->Cell(50,7,'ENTIDAD','BR',0,'C',0);
...
$Orientation="P";
$NombreEmpresa="";
$SQL="SELECT sql_rpt, page_rpt, orientacion_rpt, RazonSocial_DCD from ".$_SESSION['DB_NXS'].".itreports, itconfig where codigo_rpt='listaringresosfecha'";
...
$pdf->Settitle('LISTADO ADMISIONES');
