...
$this->Cell(0,7,'MARCACIONES ERRADAS ENTRE EL '.$_GET["FECHA_INICIAL"].' Y EL '.$_GET["FECHA_FINAL"],'B',0,'C',0);
$this->SetY(10);
$this->SetFont('Arial','',9);
...
$Orientation="P";
$NombreEmpresa="";
$SQL="SELECT sql_rpt, page_rpt, orientacion_rpt, RazonSocial_DCD from ".$_SESSION['DB_NXS'].".itreports, itconfig where codigo_rpt='erroresid'";
...
$pdf->Settitle('LISTADO MARCACIONES ERRADAS ID NEXUS');
...
$pdf->Cell(38,5,$row[7],'',0,'L',1); //ENTIDAD
$pdf->Ln();
}
mysqli_free_result($result);
