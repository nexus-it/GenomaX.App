...
$Orientation="P";
$SQL="SELECT sql_rpt, page_rpt, orientacion_rpt from ".$_SESSION['DB_NXS'].".itreports where codigo_rpt='hcptesatendidos'";
...
$pdf->Settitle('PACIENTES ATENDIDOS POR '.$_SESSION["it_user"]);
