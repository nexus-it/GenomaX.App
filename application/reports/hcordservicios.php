...
$SQL="SELECT sql_rpt from nxs_gnx.itreports where codigo_rpt='hcordservicios'";
...
$Orientation="P";
$NombreEmpresa="";
$SQL="SELECT page_rpt, orientacion_rpt from nxs_gnx.itreports where codigo_rpt='hcordservicios'";
