...
$this->Cell(0,10,'LISTADO DE FACTURAS EMITIDAS ENTRE EL '.$_GET["FECHA_INICIAL"].' Y EL '.$_GET["FECHA_FINAL"],'B',0,'C',0);
$this->SetY(10);
$this->SetFont('Arial','',9);
...
$Orientation="P";
$NombreEmpresa="";
$SQL="SELECT sql_rpt, page_rpt, orientacion_rpt, RazonSocial_DCD from ".$_SESSION['DB_NXS'].".itreports, itconfig where codigo_rpt='listarfacturasfecha'";
...
$pdf->Settitle('LISTADO FACTURAS POR PERIODO');
...
$pdf->Cell(14,5,$row[11],'',0,'R',1); //ENTIDAD
$pdf->Cell(0,5,$row[12],'',0,'L',1); //ENTIDAD
$pdf->Ln();
...
$pdf->Cell(180,6,"Facturas elaboradas en el periodo: ".$totalfacts,'T',0,'L',1); //ESTADO
