...
$this->Cell(0,10,'SERVICIOS AUTORIZADOS A PACIENTES EN EL PERIODO DEL '.$_GET["FECHA_INICIAL"].' AL '.$_GET["FECHA_FINAL"],'B',0,'C',0);
$this->SetY(10);
$this->SetFont('Arial','',9);
...
$Orientation="P";
$NombreEmpresa="";
$SQL="SELECT sql_rpt, page_rpt, orientacion_rpt, RazonSocial_DCD from ".$_SESSION['DB_NXS'].".itreports, itconfig where codigo_rpt='autorizaciones'";
...
$pdf->Settitle('AUTORIZACION DE SERVICIOS');
...
$pdf->SetFont('Arial','',8);
$pdf->Cell(24,5,$row[0].' '.$row[1],'',0,'L',0); //INGRESO
$pdf->Cell(45,5,ucwords(strtolower($row[2].' '.$row[3].' '.$row[4].' '.$row[5])),'',0,'L',1); //DOCUMENTO
$pdf->Cell(4,5,$row[6],'',0,'C',1); //ESTADO
$pdf->Cell(6,5,$row[7],'',0,'C',1); //ESTADO
$pdf->Cell(16,5,$row[8],'',0,'L',1); //ESTADO
$pdf->Cell(21,5,$row[9],'',0,'L',1); //ESTADO
$pdf->Cell(25,5,$row[10],'',0,'L',1); //ESTADO
$pdf->Cell(25,5,$row[11],'',0,'L',1); //ESTADO
$pdf->Cell(18,5,$row[12],'',0,'L',1); //ESTADO
$pdf->Cell(16,5,$row[13],'',0,'L',1); //ESTADO
$pdf->Cell(21,5,$row[14],'',0,'L',1); //ESTADO
$pdf->Cell(21,5,$row[15],'',0,'L',1); //ESTADO
$pdf->Cell(21,5,$row[16],'',0,'L',1); //ESTADO
$pdf->Cell(21,5,$row[18],'',0,'L',1); //ESTADO
$pdf->Ln();
}
mysqli_free_result($result);
//mysqli_close();
