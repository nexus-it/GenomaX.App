...
<div class="box manito" id="nxsFavDiv-'.$row[0].'" onclick="CargarForm(\'application/'.$row[3].'\',\''.$row[2].'\', \''.$iconito.'\')"  style="margin-bottom: 0px;">
  <div class="box-header" style="margin-top:2px; background-image: url('.$_SESSION["NEXUS_CDN"].'/image/icons/32x32/'.$iconito.');background-position: center;background-repeat: no-repeat;">
