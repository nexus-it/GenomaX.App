...
case 'FillAgenda' :
	...
	$tabla='<tr> <th id="thh'.$_GET['ventana'].'" colspan="3"><span id="NombreDia'.$_GET['ventana'].'"> '.$array_dias[date('l', strtotime($fecha))].'. '.$_GET['fecha'].' </span></th> </tr> <tr id="trh'.$_GET['ventana'].'"> <th  width="10%" id="thd2'.$_GET['ventana'].'">Hora</th> <th  width="20%" id="thd1'.$_GET['ventana'].'">Consultorio</th> <th  width="70%" id="thd0'.$_GET['ventana'].'">Paciente</th> </tr> ';
