...
czterceros g, cztipoid h, gxplanes i, cznotascontablesend nc WHERE c.Codigo_AFC = b.Codigo_AFC  and d.Codigo_EPS= c.Codigo_EPS  and e.Codigo_TER= d.Codigo_TER   and f.Codigo_ADM =c.Codigo_ADM   and g.Codigo_TER=f.Codigo_TER and h.Codigo_TID=g.Codigo_TID and i.Codigo_PLA= c.Codigo_PLA 
AND nc.NumeroDoc_NCT = c.Codigo_FAC
AND nc.Codigo_NCT='".$_POST["notadebito"]."' and estado_fac = 1
";
...
while ($rowH = mysqli_fetch_array($resultH)) {
	...
	//while ($row = mysqli_fetch_array($result)) {
		$detalle[] =array(
					...
					"description"=> $rowH['Descripcion_NCT'],
					"notes"=> $rowH['Descripcion_NCT'],
					"code"=> $rowH['Descripcion_NCT'],
					"type_item_identification_id"=> 4,
					"price_amount"=> $rowH['ValEntidad_FAC'],
					"base_quantity"=>  "1"
				);
	//}
