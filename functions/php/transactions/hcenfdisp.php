...
include '00trnsctns.php';
	...
	if ($OrdenDisp=='1') {
		if ($_POST['dispositivo']!='') {
			...
			$SQL="Insert into gxordenescab(Codigo_ORD, Codigo_ADM, Fecha_ORD, Codigo_ARE, Descripcion_ORD, Codigo_USR, Estado_ORD, Autorizacion_ORD) Values ('".$Consec."', '".(int)$_POST['ingreso']."', now(), '".$_POST['area']."', 'ORDEN GENERADA POR ENFERMERIA-DISPOSITIVO',  '".$_SESSION["it_CodigoUSR"]."', '1', '".$_POST['autorizacion']."')";
			EjecutarSQL($SQL, $conexion);
			$SQL="Insert Into gxordenesdet(Codigo_ORD, Codigo_SER, Cantidad_ORD, Codigo_EPS, Codigo_PLA, Codigo_TER) values('".$Consec."', '".$_POST['dispositivo']."', 1, '".TRIM($_POST['contrato'])."', '".$_POST['plan']."', '".$CodMED."') ";
			EjecutarSQL($SQL, $conexion);
