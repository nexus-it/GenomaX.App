...
include '00trnsctns.php';
	...
	$SQL="Insert Into hc_ENFERMERIA(Codigo_TER, Codigo_HCF, nota_HC) Values ('".$_POST['codigoter']."', '".$ElFolio."', '".$_POST['notaenf']."')";
	EjecutarSQL($SQL, $conexion);
	// SIGNOS VITALES
	$totalsv=12;
	for ($i = 1; $i <= $totalsv; $i++) {
	...
	it_aud('1', 'Apl. Medicamentos', 'Tercero '.$_POST['codigoter'].' - Folio Int. '.$ElFolio);
