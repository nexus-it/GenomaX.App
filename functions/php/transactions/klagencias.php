...
include '00trnsctns.php';
	...
	$SQL="replace into czterceros(Codigo_TER, ID_TER, Nombre_TER, Codigo_TID, Direccion_TER, Telefono_TER, Correo_TER, Expedicion_TER, RazonSocial_TER, DigitoVerif_TER, Web_TER) Values ('".$Consec."', '".$_POST['idagencia']."', '".trim($_POST['ncomercial'])."', ".$_POST['tipoid'].", '".$_POST['Direccion']."', '".$_POST['Telefonos']."','".$_POST['email']."', '".$_POST['expedicion']."', '".$_POST['rsocial']."', '".$dv."', '".strtolower($_POST['webpage'])."')";
	EjecutarSQL($SQL, $conexion);
