...
(function($) {
	...
	$.formValidator.defaults = {
		...
		errorDiv		:	'#warn',
		errorMsg		: 	{
								reqString		:	'Digite la informacion requerida',
								reqDate			:	'Digite <b>Fecha</b> correcta!',
								reqNum			:	'Se requiere dato numérico',
								reqMailNotValid	:	'E-mail <b>Inválido</b>!',
								reqMailEmpty	:	'E-mail requerido',
								reqSame			:	'Tekrar alanları aynı <b>değil</b>!',
								reqBoth			:	'İlgili alanları doldurmalısınız!',
								reqMin			:	'Minimo	%1 caracteres'
							},
		customErrMsg	:	'',
