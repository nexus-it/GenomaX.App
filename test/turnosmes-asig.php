...
.EstiloT {	font-family: Arial, Helvetica, sans-serif;
	font-size: 10px;
	color: #222222;
}
.EstiloT1 {	font-family: Arial, Helvetica, sans-serif;
	font-size: 11px;
	color: #222222;
	font-weight: bold;
}
...
function cambioarea(combo) {
	...
	$Coord="";
	$ContaEmple=0;
	$SQL="Select Codigo_ARE, Codigo_TER From czareas Where Estado_ARE='1';";
	include "functions/conectar.php";
	$result = mysqli_query( $conexion, $SQL);
...
<form action="turnosmes-asig2.php" method="<?php
  if (!(isset($_GET["txt_anyo"])))
  	echo 'get';
  else
  	echo 'post';
  ...
  <table border="0" align="center" cellpadding="2" cellspacing="2">
    <tr>
      ...
      <td align="left" valign="middle"><input name="txt_anyo" type="text" class="Estilo3" id="txt_anyo" value="<?php echo /*date("Y");*/ "2011"; ?>" size="4" maxlength="4" /></td>
    </tr>
    <tr>
      <td align="right" valign="middle" class="Estilo2">AREA O DEPARTAMENTO:</td>
      <td align="left" valign="middle" class="Estilo2">
	  <select name="cmb_areas" class="Estilo2" id="cmb_areas" > <?php /*?>onchange="cambioarea(this)"><?php */?>
    ...
    <tr>
      <td colspan="4" align="right" valign="middle" bgcolor="#666666"><a href="javascript: document.frm_turnos.submit();"><span class="Estilo7">ELABORAR PROGRAMACI&Oacute;N </span><img src="images/bullet_arrow_right.png" width="15" height="15" border="0" align="absmiddle" title="ELABORAR PROGRAMACIÓN" /></a></td>
    </tr>
  </table>
  <a href="turnosmes.php"><img src="images/bullet_arrow_right.png" width="16" height="16" border="0" align="left" title="&lt;&lt; ATRAS" /></a>
  <?php 
  }
  else
  {
...
*/	{
  ?>
  <table width="100%" border="1" align="center" cellpadding="0" cellspacing="0" class="EstiloT">
    <tr>
	...
	?>
      <td rowspan="2" align="center" valign="middle" class="EstiloT">TOTAL<br />
        HORAS</td>
    </tr>
    <tr>
      <?php
    ...
    <?php
$SQL="SELECT distinct NomEmple + ' ' + ApeEmple, E.CodEmple FROM TurnosEmple E, Turnos T WHERE T.CodEmple=E.CodEmple and E.CodArea='".$_GET["cmb_areas"]."' and month(Fecha)='".$_GET["cmb_mes"]."' and year(Fecha)='".$_GET["txt_anyo"]."' AND CodEmpre='".$_GET["codempre"]."'";
	include "functions/conectar.php";
	$result = mysqli_query( $conexion, $SQL);
	while ($row=mysqli_fetch_array($result)) {
?>
	...
	?>
      <td align="center" valign="middle"><input name="textfield" type="text" class="EstiloTextB" size="3" 
      <?php echo 'class="Estilo'.$Colorday.'" value="'.$row1[0].'"'; ?>/></td>
      <?php
	}
	mysqli_free_result($result1);
?>
      <td align="right" class="EstiloT1"><?php 
	  $HorasDesc=0;
