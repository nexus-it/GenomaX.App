...
<video id="mivideo" autoplay="autoplay" playsinline autoplay muted loop>
  ...
  <source src="<?php echo $_SESSION["NEXUS_CDN"]; ?>/video/invoix/<?php echo $nxslgn; ?>" type="video/webm"></source>
</video>
...
<div class="container">
    <div class="row login_box">
        ...
        <div class="col-md-12 col-xs-12" align="center">
            <div class="line"><h3><img src="<?php echo $_SESSION["NEXUS_CDN"]; ?>/image/title_invoix.png"  alt="InvoiX" title="InvoiX"/> </h3> </div>
            <div class="outter"><img src="<?php echo $_SESSION["NEXUS_CDN"]; ?>/image/login_invoix.png" class="image-thumbnail" style="width:200px"/></div>   
