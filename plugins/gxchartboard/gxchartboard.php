...
<?php
    ...
    $SQL="SELECT DISTINCT a.Codigo_MNU, a.Nombre_MNU, COUNT(c.Codigo_ITM) FROM itdashboard k, ".$_SESSION['DB_NXS'].".itmenu a, ".$_SESSION['DB_NXS'].".ititems b, itpermisos c, itperfiles d, itusuarios e 
