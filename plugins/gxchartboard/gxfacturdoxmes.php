...
echo 
'
function Loadgxfacturdoxmes(deztino)
{
    ...
    colors: [\'#3A9A6C\', \'#B4710C\', \'#B5646C\', \'#873D27\', \'#60E747\', \'#0080C0\', \'#60E747\', \'#804040\', \'#FF9900\', \'#808000\'],
    xAxis: {
        categories: [
';
...
$SQL="Select distinct b.Nombre_EPS, b.Codigo_EPS, sum(a.ValTotal_FAC) From gxfacturas a Inner Join gxeps b On b.Codigo_EPS=a.Codigo_EPS Where a.Estado_FAC<>'0' and a.Fecha_FAC BETWEEN DATE_ADD(NOW(), INTERVAL -5 MONTH) AND NOW() Group BY b.Nombre_EPS, b.Codigo_EPS Order BY sum(a.ValTotal_FAC) desc";
    $seriex="";
